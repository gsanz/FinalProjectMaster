...
initialize: function() { 
		var self = this;
		// crear el mapa la primera vez que se muestra la página
		$(document).one('pageshow', '#' + this.$el.attr('id'), function(e, data) { // crear contenedor
...
// guardar información sobre las rutas pintadas
